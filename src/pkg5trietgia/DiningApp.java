...
public class DiningApp {
    ...
    public DiningApp(SynchronizationMechanism syncMechanism) {
  ...
  private void startDining() {
    ...
    private void addDiners() {
        ...
        for (int i = 0; i < 5; ++i) {
            ...
            philosophers.add(new Philosopher(i + 1, forkList.get(i), forkList.get(rightFork), synchronizationMechanism));
        }
    }
